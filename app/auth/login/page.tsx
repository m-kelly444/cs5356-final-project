...
export default function LoginPage() {
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-12 sm:px-6 lg:px-8 bg-gray-900">
      <Card className="w-full max-w-md border border-cyan-500/30 shadow-lg shadow-cyan-500/20 backdrop-blur-sm">
        <CardHeader className="pb-4 text-center">
          <CardTitle className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-cyan-500 to-fuchsia-500">
